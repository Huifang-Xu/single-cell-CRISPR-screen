...
#SBATCH --time=4-00:00:00                  # Time limit hrs:min:sec or days-hours:minutes:seconds
...
workDir="/scratch/hx37930/reference/hg38_dCas9"

split-pipe \
	--mode mkref \
	--genome_name hg38_dCas9 \
	--fasta ${workDir}/Homo_sapiens.GRCh38.dna.primary_assembly.dCas9.fa.gz \
	--genes ${workDir}/Homo_sapiens.GRCh38.109.dCas9.gtf.gz \
